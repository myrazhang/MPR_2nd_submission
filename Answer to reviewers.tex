...
has been reformulated to have it working under general settings deterministic timed Petri net. 
...
can be easily expanded to an MP model of TPN optimization. (\textcolor{blue}{to be expanded})
